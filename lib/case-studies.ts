...
export const caseStudies: CaseStudy[] = [
  reworkCaseStudy,
  {
    ...
    outcome: "The intended outcome is one controlled path for release work, with unresolved documents and review decisions visible before handoff. This concept draws on previous workplace experience; it is not a deployed customer system and has no measured business outcomes.",
    limitations: "Ellwood Flow is a concept prototype inspired by a previous job, not a system adopted by that employer. Its current workflow reflects the release and document-control needs implemented so far, and broader customer validation, integrations, and measured business outcomes remain future work.",
    media: [
      {
        id: "active-release-workspace",
        type: "screenshot",
        label: "Active release workspace",
        description: "The prototype Ellwood Flow active-release workspace showing header metadata, panel marks, drawing review, and revision controls.",
      ...
      },
      {
        ...
        description: "The prototype release catalog showing status filters, search, job associations, and revision tracking.",
      ...
      },
      {
        ...
        description: "The prototype production queue with step-by-step station routing, work orders, and panel completion status.",
      ...
      },
      {
        ...
        description: "The prototype material inventory view distinguishing on-hand, committed, and allocated sheet goods.",
      ...
      },
      {
        ...
        description: "The prototype QC station recording pass, rework, remake, scrap decisions, and reason codes.",
      ...
      },
      {
        ...
        description: "The prototype pallet planner optimizing stacking rules, height restrictions, and weight constraints.",
      ...
      },
      {
        ...
        description: "The prototype shipping staging surface managing bills of lading, pallet assignments, and carrier handoffs.",
      ...
      },
      {
        ...
        description: "The prototype scan station providing fast barcode scanning, station progression, and obsolete revision alerts.",
      ...
      },
      {
        ...
        description: "The prototype global lookup tool for tracing any job, release, panel mark, or barcode history.",
      ...
      },
      {
        ...
        description: "The prototype administration dashboard with user roles, permissions, and immutable audit logs.",
      ...
      },
      {
        ...
        description: "The prototype operational reports view providing throughput, scrap rate, and release cycle time analytics.",
  ...
  },
  {
    ...
    "kicker": "Operations",
    "summary": "An online, actively developing owner-operated command center and modular operations platform connecting client delivery, industrial workflows, infrastructure, and evidence-backed improvement work in one system.",
  ...
  },
  {
    ...
    summary: "An original, self-initiated restaurant concept built as a mobile-first tableside POS and collaborative-ordering prototype that carries diners, configured items, guest proposals, kitchen status, split payments, and an intentionally sarcastic brand voice through one restaurant workflow.",
  ...
  },
  {
    ...
    summary: "An employee-label tool inspired by a previous job and used in that workplace for a period. It supports a workflow for assigning unique employee numbers, generating standardized Code 128 labels, printing label sheets, and sharing barcode images for downstream production, completion, quality, packaging, or handoff scans.",
    ...
    paths: [
      { label: "Explore the barcode tool", description: "Use the deployed employee-label workflow for directory management, barcode preview, print-sheet composition, and label sharing.", href: "https://barcodes.4twenty.dev", external: true },
    ...
    outcomeLabel: "Operational outcome",
    outcome: "The tool was used in a previous workplace for a period to support employee barcode labels. It is presented as past workplace use, not a currently active system. No measured throughput, accuracy, or labor-savings improvement is claimed.",
    ...
    media: [{ id: "barcode-tool-overview", type: "placeholder", label: "Employee barcode workflow", description: "Planned desktop and mobile views of the employee directory, label builder, live barcode preview, print sheet, and share workflow.", caption: "Portfolio screenshots of the previously used employee-barcode tool have not been supplied yet.", requestedAsset: "Supply a desktop label-builder or employee-directory view plus a mobile preview or share-sheet view with employee information safely redacted." }],
